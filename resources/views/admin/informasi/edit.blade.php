    ...
    <div class="col-md-8 px-4">
        <div class="card p-2">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('admin.informasi.update' , $information->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Judul</label>
                                <input class="form-control" type="text" placeholder="Judul" name="title"
                                    value="{{ $information->title }}" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                            <div class="form-group">
                                <label for="example-text-input" class="form-control-label">Deksripsi</label>
                                <textarea class="form-control" type="text" placeholder="Deksripsi" name="description"
                                    onfocus="focused(this)" onfocusout="defocused(this)">{{ $information->description }}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Gambar</label>
                                ...
                                <div class="col-auto mt-3">
                                    @if ($information->image)
                                        <div class="avatar avatar-xxl position-relative">
                                            <img alt="image"
                                                src="{{ asset('storage/images/information/' . $information->image) }}"
                                                class="w-100 border-radius-sm" id="preview_image">
                                        </div>
                                    @else
                                        <div class="avatar avatar-xxl position-relative">
